...
/* Mission System Settings */
	...
	DMS_TimeBetweenMissions				= [500,900];				// [Minimum,Maximum] time between missions (if mission limit is not reached) | DEFAULT: 10-15 mins
	DMS_MissionTimeOut					= [21600,21600]; 				// [Minimum,Maximum] time it will take for a mission to timeout | DEFAULT: 15-30 mins
	...
	DMS_MarkerText_AIName				= "Hostiles";					// What the AI will be called in the map marker. For example, the marker text can show: "Car Dealer (3 Units remaining)"
	DMS_MarkerPosRandomization			= true;					// Randomize the position of the circle marker of a mission
	DMS_MarkerPosRandomRadius			= [25,200];					// Minimum/Maximum distance that the circle marker position will be randomized | DEFAULT: 0 meters to 200 meters
	...
	DMS_MissionMarkerWinDotTime			= 60;						// How many seconds the "win" mission dot will remain on the map
	DMS_MissionMarkerLoseDotTime		= 60;						// How many seconds the "lose" mission dot will remain on the map
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_unfreezingDistance			= 3500;						// If there are playerfs within this distance of the leader of an AI group, then the AI group will be "un-frozen".
	DMS_ai_offloadOnUnfreeze			= true;						// Whether or not to ofload AI to clients once they have been "un-frozen". NOTE: This config will be ignored if "DMS_ai_offload_to_client" is set to false.
	...
	DMS_AI_destroyVehicleChance			= 5;						// Percent chance that an AI vehicle will be destroyed after the AI have been killed. Set to 100 for always, or 0 for never.
