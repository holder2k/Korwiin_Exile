...
class CfgSettings
{
	...
	class BambiSettings
	{
		...
		spawnZoneVehicles[] =
		{
			{1, "Exile_Car_Volha_Blue"},
			{1, "Exile_Car_Volha_White"},
			{1, "Exile_Car_Lada_Taxi"},
			{1, "Exile_Car_Lada_Green"},
			{1, "Exile_Car_Lada_Hipster"},
			{1, "Exile_Car_Lada_Red"},
			{1, "Exile_Car_Lada_White"},
			{1, "Exile_Car_Ikarus_Blue"}
		};
	};
